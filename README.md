...
RCC_ClkInitStruct.ClockType = RCC_CLOCKTYPE_HCLK | RCC_CLOCKTYPE_SYSCLK | RCC_CLOC
...
![alt text](<Output screen shots of proteus.png>)

## Proteus layout(Add pdf screen shot of circuit here)

 ![alt text](<Proteus layout(Add pdf screen shot of circuit here).jpg>)
